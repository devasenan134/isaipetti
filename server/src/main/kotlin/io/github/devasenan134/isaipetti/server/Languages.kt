...
object Languages {
    ...
    /**
     * Common English words. Tamil (or Telugu, Hindi) titles written in English letters almost never
     * contain them, while English titles usually do.
     */
    ...
    private const val ENGLISH_TITLE = 1.5
    ...
    fun infer(
        ...
        repeat(2) {
            ...
            for (i in 0 until n) {
                ...
                byAlbum.getOrPut(songs[i].albumId) { mutableMapOf() }.merge(l, 1.0, Double::plus)
            ...
            for (i in 0 until n) {
                ...
                byAlbum[songs[i].albumId]?.let { add(votes, it, 2.0) }
        ...
        if (indianFilm != null && western != null) {
            ...
            for (i in 0 until n) {
                ...
                if (lean > 1.2f && mainIndian != null) language[i] = mainIndian
                else if (lean < -1.2f) language[i] = "English"
            }
        }
        ...
        if (labelled.size >= 20) {
            ...
            for (i in 0 until n) {
                ...
                val disagrees = !lean.isNaN() && ((best == "English" && lean > 0.5f) || (best != "English" && lean < -0.5f))
